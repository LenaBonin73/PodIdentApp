fluidRow(
  column(12,
         HTML(
         "<strong> <font size = '6'> Welcome to PodIndentApp ! </font> </strong> <br> 
         This app helps you to vizualise, explore and compare podocyte data from different studies <br>
         <br>
...
<font size = +1> <strong>
More info about the app can be found on <a href = https://github.com/LenaBonin73/PodIndentApp> https://github.com/LenaBonin73/PodIndentApp </a> </strong> </font> <br>
         <br>")
  )
